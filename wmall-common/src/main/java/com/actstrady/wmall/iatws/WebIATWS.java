...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String apiKey = "9c4100adba10b32ef4f380a748aa8734"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "6befd661f12c1598f066c53fccb18229"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5cf0c5a5"; //在控制台-我的应用获取
    private ResponseVo response = new ResponseVo();
    private String file = "";
            ...
            if (resp.getData() != null) {
                if (resp.getData().getResult() != null) {
                    ...
                    try {
                        ...
                        response.setMessage(decoder.toString());
                        response.setCode("1");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
